        ...
        <div className="space-y-8 text-slate-400">
          ...
          <div className="p-8 rounded-lg border border-red-600/30 bg-red-600/5">
            ...
            <p className="text-lg leading-relaxed mb-4">
              By leveraging advanced matching algorithms that take into account blood type compatibility, geographic location, medical urgency, and donor availability, LifeLink connects verified hospitals, willing donors, and patients waiting for a second chance at life.
            </p>
            <p className="text-lg leading-relaxed">
          ...
          <div className="p-8 rounded-lg border border-red-600/30 bg-red-600/5">
            ...
            <ul className="space-y-4">
              <li className="flex gap-4">
                ...
                <span>All hospitals on our platform undergo rigorous verification to ensure legitimacy.</span>
              </li>
              <li className="flex gap-4">
              ...
              <li className="flex gap-4">
                ...
                <span>Our platform is available to all qualified donors, recipients, and hospitals.</span>
              </li>
            </ul>
          </div>
